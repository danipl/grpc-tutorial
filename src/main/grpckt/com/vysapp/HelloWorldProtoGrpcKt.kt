...
import com.vysapp.GreeterGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for com.vysapp.Greeter.
 */
public object GreeterGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) com.vysapp.Greeter service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the com.vysapp.Greeter service based on Kotlin coroutines.
   */
  public abstract class GreeterCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext,
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for com.vysapp.Greeter.SayHello.
     *
    ...
    public open suspend fun sayHello(request: HelloRequest): HelloReply = throw
        StatusException(UNIMPLEMENTED.withDescription("Method com.vysapp.Greeter.SayHello is unimplemented"))
